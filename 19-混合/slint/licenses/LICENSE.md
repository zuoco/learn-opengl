...
A ***Desktop Application*** is a computer program that is designed to run off a general-purpose computer (PC or notebook), typically installed and executed locally on the computer's operating system.
